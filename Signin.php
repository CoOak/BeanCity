...
<body>
	...
	<div class="container">
		...
		<form class="form" action="signinServlet.php" method="POST">
			<input placeholder="Username" id="email" name="name" class="input" required="" />
			<input placeholder="Phone Number" id="email" name="phone" class="input" required="" />
			<input placeholder="Password" id="password" name="pass" type="password" class="input" required="" />
			<input placeholder="Password" id="password" name="cpass" type="password" class="input" required="" />
			<span class="forgot-password"><a href="#">Forgot Password ?</a></span>
			<input value="Sign In" type="submit" class="login-button" name="submit" />
		</form>
		<div class="social-account-container">
			<span class="title"><a href="Login.php">Or Sign in with</a> </span>
	...
	<div class="singup">
		<div class="login-box">
			...
			<form class="form" action="signinServlet.php" method="POST">
				...
				<div class="user-box">
					<input required="" id="email" name="phone" type="number">
				...
				<div class="user-box">
					<input required="" id="password" name="cpass" type="password">
					<label>စကားဝှက်ပြန်ရိုက်ထည့်ပါ</label>
				</div>
				<input value=" အကောင့် အသစ်ဖွင့်ပါ" type="submit" class="login-button" name="submit" />
			</form>
			<p class="mt-3">အကောင့်ရှိပြီးသားလား? <a href="Login.php" class="a2 mt-3">အကောင့်၀င်ပါ</a></p>
		</div>
	</div>
